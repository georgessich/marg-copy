...
export default function BookCard({ item, handleCategoryClick }) {
  ...
  return (
    <div className='flex flex-col justify-start items-center bg-zinc-100 m-1'>
        ...
        <Link href={`/product/${item.slug}`}  className='hover:text-zinc-400 px-8 py-1 text-lg self-start'>{item.title}</Link>
